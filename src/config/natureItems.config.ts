...
export const NATURE_ITEMS: NatureItem[] = [
  ...
  {
    id: "purple_flower_bush",
    label: "Purple Flower Bush",
    emoji: "🌿",
    description: "A bush adorned with vibrant purple flowers.",
    component: "Bush",
    props: { direction: 0 },
    windAffected: false,
    windNode: null,
  ...
  },
  {
    ...
    label: "Stag Statue",
    emoji: "🦌",
    description: "A majestic stag statue, standing guard.",
    component: "StagStatue",
    props: { direction: 0 },
    windAffected: false,
    windNode: null,
    groundOffset: 0,
  ...
  },
  {
    ...
    label: "Fox Statue",
    emoji: "🦊",
    description: "A charming fox statue, watching over the path.",
    component: "FoxStatue",
    props: { direction: 0 },
    windAffected: false,
    windNode: null,
